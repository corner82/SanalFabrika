...
return array(
    'controllers' => array(
        'invokables' => array(
            'Comics\Controller\Comics' => 'Comics\Controller\ComicsController',
        ...
        'routes' => array(
            'home' => array(
                ...
                'options' => array(
                    'route' => '/',
                    'defaults' => array(
                        'controller' => 'Comics\Controller\Comics',
                        'action' => 'index',
                    ),
                ),
            ),
            ...
            'comics' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '[/:lang]/comics[/:action][/:id][/:selectedCompanyShN][/:selectedCompanyNpk]', 
                    'constraints' => array(
